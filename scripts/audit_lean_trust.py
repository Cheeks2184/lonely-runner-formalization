...
def main() -> None:
    ...
    required_probes = {
        ...
        "LonelyRunner.MinimalPositiveIntegerFailure.two_le_count",
        "LonelyRunner.MinimalPositiveIntegerFailure.deletion_seed_interval",
        "LonelyRunner.MinimalPositiveIntegerFailure.exists_common_deletion_margin",
